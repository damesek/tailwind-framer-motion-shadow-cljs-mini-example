...
/** @this {Function} */
(cljs.tools.reader.impl.errors.throw_ex.cljs$lang$applyTo = (function (seq41374){
var G__41375 = cljs.core.first(seq41374);
var seq41374__$1 = cljs.core.next(seq41374);
var G__41376 = cljs.core.first(seq41374__$1);
var seq41374__$2 = cljs.core.next(seq41374__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41375,G__41376,seq41374__$2);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___41544 = arguments.length;
var i__4737__auto___41545 = (0);
while(true){
if((i__4737__auto___41545 < len__4736__auto___41544)){
args__4742__auto__.push((arguments[i__4737__auto___41545]));

var G__41546 = (i__4737__auto___41545 + (1));
i__4737__auto___41545 = G__41546;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.reader_error.cljs$lang$applyTo = (function (seq41384){
var G__41385 = cljs.core.first(seq41384);
var seq41384__$1 = cljs.core.next(seq41384);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41385,seq41384__$1);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___41549 = arguments.length;
var i__4737__auto___41550 = (0);
while(true){
if((i__4737__auto___41550 < len__4736__auto___41549)){
args__4742__auto__.push((arguments[i__4737__auto___41550]));

var G__41554 = (i__4737__auto___41550 + (1));
i__4737__auto___41550 = G__41554;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.illegal_arg_error.cljs$lang$applyTo = (function (seq41394){
var G__41395 = cljs.core.first(seq41394);
var seq41394__$1 = cljs.core.next(seq41394);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41395,seq41394__$1);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___41555 = arguments.length;
var i__4737__auto___41556 = (0);
while(true){
if((i__4737__auto___41556 < len__4736__auto___41555)){
args__4742__auto__.push((arguments[i__4737__auto___41556]));

var G__41557 = (i__4737__auto___41556 + (1));
i__4737__auto___41556 = G__41557;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.eof_error.cljs$lang$applyTo = (function (seq41407){
...
while(true){
if((i__4737__auto___41567 < len__4736__auto___41566)){
args__4742__auto__.push((arguments[i__4737__auto___41567]));

var G__41568 = (i__4737__auto___41567 + (1));
i__4737__auto___41567 = G__41568;
continue;
} else {
}
break;
...
var init = (function (){var G__41484 = kind;
var G__41484__$1 = (((G__41484 instanceof cljs.core.Keyword))?G__41484.fqn:null);
switch (G__41484__$1) {
case "regex":
return "#\"";
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__41484__$1)].join('')));
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.throw_eof_reading.cljs$lang$applyTo = (function (seq41474){
var G__41475 = cljs.core.first(seq41474);
var seq41474__$1 = cljs.core.next(seq41474);
var G__41476 = cljs.core.first(seq41474__$1);
var seq41474__$2 = cljs.core.next(seq41474__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41475,G__41476,seq41474__$2);
}));
...
var iter__4529__auto__ = (function cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__41520(s__41521){
return (new cljs.core.LazySeq(null,(function (){
var s__41521__$1 = s__41521;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__41521__$1);
if(temp__5753__auto__){
var s__41521__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__41521__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__41521__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__41523 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__41522 = (0);
while(true){
if((i__41522 < size__4528__auto__)){
var vec__41527 = cljs.core._nth(c__4527__auto__,i__41522);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41527,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41527,(1),null);
if((freq > (1))){
cljs.core.chunk_append(b__41523,id);

var G__41589 = (i__41522 + (1));
i__41522 = G__41589;
continue;
} else {
var G__41590 = (i__41522 + (1));
i__41522 = G__41590;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__41523),cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__41520(cljs.core.chunk_rest(s__41521__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__41523),null);
}
} else {
var vec__41530 = cljs.core.first(s__41521__$2);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41530,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41530,(1),null);
if((freq > (1))){
return cljs.core.cons(id,cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__41520(cljs.core.rest(s__41521__$2)));
} else {
var G__41594 = cljs.core.rest(s__41521__$2);
s__41521__$1 = G__41594;
continue;
}
}
} else {
