...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_41247 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_41247(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_41251 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_41251(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41260 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41260(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41263 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41263(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41267 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41267(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41275 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41275(reader);
}
});
...
var G__41396 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__41397 = s.append(c);
c = G__41396;
s = G__41397;
continue;
}
