...
var G__51589 = o;
goog.object.set(G__51589,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__51626__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__51626 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__51627__i = 0, G__51627__a = new Array(arguments.length -  0);
while (G__51627__i < G__51627__a.length) {G__51627__a[G__51627__i] = arguments[G__51627__i + 0]; ++G__51627__i;}
  args = new cljs.core.IndexedSeq(G__51627__a,0,null);
} 
return G__51626__delegate.call(this,args);};
G__51626.cljs$lang$maxFixedArity = 0;
G__51626.cljs$lang$applyTo = (function (arglist__51628){
var args = cljs.core.seq(arglist__51628);
return G__51626__delegate(args);
});
G__51626.cljs$core$IFn$_invoke$arity$variadic = G__51626__delegate;
return G__51626;
})()
;
} else {
...
var G__51590 = o;
goog.object.set(G__51590,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__51645__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__51645 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__51646__i = 0, G__51646__a = new Array(arguments.length -  0);
while (G__51646__i < G__51646__a.length) {G__51646__a[G__51646__i] = arguments[G__51646__i + 0]; ++G__51646__i;}
  args = new cljs.core.IndexedSeq(G__51646__a,0,null);
} 
return G__51645__delegate.call(this,args);};
G__51645.cljs$lang$maxFixedArity = 0;
G__51645.cljs$lang$applyTo = (function (arglist__51647){
var args = cljs.core.seq(arglist__51647);
return G__51645__delegate(args);
});
G__51645.cljs$core$IFn$_invoke$arity$variadic = G__51645__delegate;
return G__51645;
})()
;
} else {
...
var G__51593 = props;
var G__51593__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51593,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__51593);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51593__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__51597 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51597,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__51597;
}
})(),id_class);
...
var G__51598 = (cljs.core.count(argv) - first_child);
switch (G__51598) {
case (0):
...
var vec__51599 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51599,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51599,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51599,(2),null);
...
var temp__5757__auto___51668 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___51668 == null)){
} else {
var key_51669 = temp__5757__auto___51668;
(jsprops.key = key_51669);
}
...
var temp__5757__auto___51671 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___51671 == null)){
} else {
var key_51673 = temp__5757__auto___51671;
(jsprops.key = key_51673);
}
...
var temp__5757__auto___51678 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___51678 == null)){
} else {
var key_51682 = temp__5757__auto___51678;
(jsprops.key = key_51682);
}
...
var temp__5757__auto___51703 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___51703 == null)){
} else {
var key_51704 = temp__5757__auto___51703;
(jsprops.key = key_51704);
}
...
var temp__5757__auto___51705 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___51705 == null)){
} else {
var key_51706 = temp__5757__auto___51705;
(jsprops.key = key_51706);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__51602_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__51602_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__51603 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51603,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51603,(1),null);
...
break;
default:
var G__51708 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__51709 = compiler;
v = G__51708;
compiler = G__51709;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template51609 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template51609 = (function (opts,id,fn_to_element,meta51610){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template51609.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_51611,meta51610__$1){
var self__ = this;
var _51611__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template51609(self__.opts,self__.id,self__.fn_to_element,meta51610__$1));
}));

(reagent.impl.template.t_reagent$impl$template51609.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_51611){
var self__ = this;
var _51611__$1 = this;
return self__.meta51610;
}));

(reagent.impl.template.t_reagent$impl$template51609.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template51609.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template51609.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template51609.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template51609.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta51610","meta51610",-1843909336,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template51609.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template51609.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template51609");

(reagent.impl.template.t_reagent$impl$template51609.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template51609");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template51609.
 */
reagent.impl.template.__GT_t_reagent$impl$template51609 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template51609(opts__$1,id__$1,fn_to_element__$1,meta51610){
return (new reagent.impl.template.t_reagent$impl$template51609(opts__$1,id__$1,fn_to_element__$1,meta51610));
});

}

return (new reagent.impl.template.t_reagent$impl$template51609(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
